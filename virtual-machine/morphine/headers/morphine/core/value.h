...
#define valueI_object_or_panic(I, S, x)  ({struct object *_obj = objectI_cast(x); if(morphinem_unlikely(_obj == NULL)) throwI_message_panic((I), (S), "Object is null"); ((struct value) { .type = (enum value_type) (_obj->type), .object.header = _obj });})
...
#define valueI_safe_as(t, x, o) ({struct value _a = (x); (morphinem_likely(valueI_is_##t(_a)) ? valueI_as_##t(_a) : (o));})
...
#define valueI_safe_as_object(x, o) ({struct value _a = (x); (morphinem_likely(valueI_is_object(_a)) ? valueI_as_object(_a) : (o));})

// endregion

// region as_or_error

#define valueI_as_or_error(S, t, x) ({struct value _a = (x); if(morphinem_unlikely(!valueI_is_##t(_a))) throwI_message_error((S), "Expected " #t); valueI_as_##t(_a);})
...
#define valueI_as_object_or_error(S, x) ({struct value _a = (x); if(morphinem_unlikely(!valueI_is_object(_a))) throwI_message_error((S), "Expected object"); valueI_as_object(_a);})
