...
MORPHINE_API bool mapi_metatable_test(morphine_state_t S, const char *field) {
    ...
    struct value mt;
    bool result = metatableI_test(S->I, source, metatableI_string2field(S->I, field), &mt);
