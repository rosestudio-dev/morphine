...
MORPHINE_API void mapi_push_native(morphine_coroutine_t U, mfunc_native_t native) {
...
MORPHINE_API mfunc_native_t mapi_native_function(morphine_coroutine_t U) {
    struct native *native = valueI_as_native_or_error(U->I, stackI_peek(U, 0));
