...
mspec_metatable_field(ITERATOR_INIT, iterinit) // (callable)
mspec_metatable_field(ITERATOR_HAS, iterhas)   // (callable | value)
mspec_metatable_field(ITERATOR_NEXT, iternext) // (callable | value)
