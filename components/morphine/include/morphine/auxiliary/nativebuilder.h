...
#define maux_nb_end         }} mapi_error(_maux_nb_coro, "undefined state"); _maux_nb_end_leave: mattr_unused; return;

#define maux_nb_init()   case (0): { mapi_continue(_maux_nb_coro, 1); do { } while(0)
#define maux_nb_state(s) goto _maux_nb_end_leave; } case (s): { _maux_nb_immediately_##s: mattr_unused; mapi_continue(_maux_nb_coro, (s) + 1); do { } while(0)
...
#define maux_nb_operation(op, s) do { mapi_continue(_maux_nb_coro, (s)); if (mapi_op(_maux_nb_coro, (op))) { goto _maux_nb_end_leave; } mapi_set_result(_maux_nb_coro); maux_nb_im_continue(s); } while(0)
