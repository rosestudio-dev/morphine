...
struct value vectorI_first(morphine_instance_t, struct vector *, bool *has);
struct pair vectorI_next(morphine_instance_t, struct vector *, struct value *key, bool *next);
