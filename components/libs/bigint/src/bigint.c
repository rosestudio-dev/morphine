...
static struct mc_bigint *bigint_from(morphine_coroutine_t U) {
    ...
    } else if (mapi_is_type(U, MC_BIGINT_USERDATA_TYPE)) {
...
static inline void raw_binary(
    ...
    struct mc_bigint *(*function_type1)(morphine_coroutine_t, struct mc_bigint *, struct mc_bigint *, struct mc_bigint *)
) {
    maux_nb_function(U)
        maux_nb_init
            struct mc_bigint *bigintA;
            struct mc_bigint *bigintB;
            struct mc_bigint *result = NULL;
            if (mapi_args(U) == 3) {
                mapi_push_arg(U, 0);
...
static inline void binary(
    morphine_coroutine_t U,
    struct mc_bigint *(*function_type1)(morphine_coroutine_t, struct mc_bigint *, struct mc_bigint *, struct mc_bigint *),
    void (*function_type2)(morphine_coroutine_t, struct mc_bigint *, struct mc_bigint *)
) {
    maux_nb_function(U)
        maux_nb_init
        ...
        maux_nb_operation(1, "type")
            ...
            mapi_push_string(U, "instance");
            mapi_table_get(U);
            struct mc_bigint *bigintA = mlapi_get_bigint(U);
...
static void op_bigint_less(morphine_coroutine_t U, struct mc_bigint *bigintA, struct mc_bigint *bigintB) {
...
static void op_bigint_equal(morphine_coroutine_t U, struct mc_bigint *bigintA, struct mc_bigint *bigintB) {
    mapi_push_boolean(U, mlapi_bigint_compare(bigintA, bigintB) == 0);
}
...
static void lib_bigint_negate(morphine_coroutine_t U) {
    maux_nb_function(U)
        maux_nb_init
            ...
            mapi_push_string(U, "instance");
            mapi_table_get(U);
            struct mc_bigint *bigint = mlapi_get_bigint(U);
...
static void lib_raw_bigint_compare(morphine_coroutine_t U) {
    maux_nb_function(U)
        maux_nb_init
            ...
            mapi_push_arg(U, 1);
            struct mc_bigint *bigintB = bigint_from(U);
