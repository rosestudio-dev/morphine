...
object Printer {
    ...
    private fun bytecodeFunction(source: String, bytecode: Bytecode, function: Bytecode.Function) {
        ...
        val main = if (bytecode.mainFunction == function.uid) {
            " main"
        } else {
            ""
        }
        ...
        println("function '${function.name}'(${function.uid})$main$optimized (instructions: ${function.instructions.size}, constants: ${function.constants.size}, args: ${function.argumentsCount}, closures: ${function.closuresCount}, statics: ${function.staticsCount}, slots: ${function.slotsCount}, params: ${function.paramsCount}):")
